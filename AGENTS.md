# Santa Backend Agent Instruction

Santa is a NestJS GraphQL monorepo migrated from a real-estate platform into a Korean new car selling platform.
...
- Use Santa/vehicle/car terminology for the main catalog entity where branding is involved.
- Santa sells only NEW cars in South Korea.
...
5. Replace old domain terminology step by step: real estate/petshop terms → Santa vehicle terms.
